                    ...
                    <div class="nft-card h-100 bg-base radius-16 overflow-hidden d-flex flex-column">
                        ...
                        <div class="p-10 d-flex flex-column justify-content-between flex-grow-1">
                            <div>
                                ...
                                <span class="text-sm fw-semibold text-primary-600">{{ $tryout->batch->nama }}</span>
                                ...
                                @if ($tryout->status == 'finished')
                                    ...
                                    <div class="mt-7 d-flex align-items-center justify-content-between gap-8 flex-wrap">
                                ...
                                @else
                                    <div
                                        ...
                                        <span class="text-sm text-secondary-light fw-medium">Waktu:
                                            <span class="text-sm text-primary-light fw-semibold">{{ $tryout->waktu }}
                                                Menit</span>
                                        </span>
                                    </div>
                                    <div class="mt-7 d-flex align-items-center justify-content-between gap-8 flex-wrap">
                            ...
                            <div class="d-flex align-items-center flex-wrap gap-8" style="margin-top: auto;">
                                @if ($tryout->status == 'finished')
                                    <a href="{{ route('tryouts.hasil.index', $tryout->tryout_id) }}" wire:navigate
                                    ...
                                    <a href="{{ route('tryouts.hasil.pembahasan', $tryout->tryout_id) }}" wire:navigate
                                ...
                                @elseif ($tryout->status == 'started' || $tryout->status == 'paused')
                                    <a href="{{ route('tryouts.show', ['id' => $tryout->tryout_id]) }}" wire:navigate
